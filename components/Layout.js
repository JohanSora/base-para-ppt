...
import locationsVendedor from "./locationsVendedor";
    ...
    <div className="containerGlobal">
      <div className="globalContent bg-primary">
        <div className="containerLayout">
          <div className="containerRedirections">
            {locations.map(({ icon, page, text }, index) => {
              console.log(location, page);
              return (
                <div className="containerItemLayout" key={index}>
                  <div
                    className={
                      location === page ? "itemLayoutSelect" : "itemLayout"
                    }
                    key={index}
                    onClick={() => href(page)}
                  >
          ...
          >
            <figure>
              <img src="/assets/Icons/shcart.png" width={40} height={40} />
            </figure>
            Ricoh Market
          </div>
        </div>
      ...
      <div className="navbar bg-primary">
        <div className="logoAdobeLayout">
          <figure onClick={() => router.push("/dashboard")}>
            <img src="/assets/login/Ricoh.png" alt="logo" />
          </figure>
          <p>Ricoh Incentives</p>
        </div>
        ...
        <div className="digipoints">
          <button onClick={() => router.push("/digipoints")}>
            ...
            <span></span>
            <span></span>
            <span></span> <strong>1234</strong> - RICHPOINTS
          </button>
        </div>
      ...
      <div className="bgAPC">
        <figure>
          <img src="/assets/Icons/RicohBG.png" />
        </figure>
      </div>
    </div>
  );
